...
{ 
    ...
    $email = $_POST['email']; 
    $password = $_POST['pass']; 
    $query = "INSERT INTO user_stud (fullname,userName,email,pass) VALUES ('$fullname','$userName','$email','$password')"; 
...
{ 
    ...
    { 
        $query = mysql_query("SELECT * FROM user_stud WHERE userName = '$_POST[user]' AND pass = '$_POST[pass]'") or die(mysql_error()); 
